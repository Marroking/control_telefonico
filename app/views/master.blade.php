			        ...
			        <li class="{{ set_active('/') }}"><a href="/">Inicio</a></li>
			      	@if (!Sentry::check())
							@else
								...
								<li class="{{ set_active_admin('admin/departments') }}"><a href="/admin/departments/">Departamento</a></li>
								<li class="{{ set_active_admin('admin/cellphones') }}"><a href="/admin/cellphones/">Celulares</a></li>
								<li class="{{ set_active_admin('admin/type_costs') }}"><a href="/admin/type_costs/">Tipo de Gasto</a></li>
